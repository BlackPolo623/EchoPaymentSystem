...
const CONFIG = {
    ...
    funpoint: {
        ...
        // BP 系統 URL - 不記錄交易
        ReturnURL: "https://bachuan-3cdbb7d0b6e7.herokuapp.com/php/bp_notify.php",
        ClientBackURL: "https://bachuan-3cdbb7d0b6e7.herokuapp.com/bp.html",
        OrderResultURL: "https://bachuan-3cdbb7d0b6e7.herokuapp.com/php/bp_result.php",
        // ATM 專用設定
        PaymentInfoURL: "https://bachuan-3cdbb7d0b6e7.herokuapp.com/php/bp_notify.php",
        ClientRedirectURL: "https://bachuan-3cdbb7d0b6e7.herokuapp.com/php/bp_atm_redirect.php"
    },
    // SmilePay設定
    smilepay: {
        dcvc: "16761",
    ...
    try {
        ...
        if (payMethod === 'credit') {
            ...
            const params = new URLSearchParams({
                ...
                Od_sob: 'BP Payment Service',
                Amount: amount,
                Email: CONFIG.orderPrefix.toLowerCase() + uniqueId + '@bp.payment',
                Pay_zg: payMethod,
                Data_id: uniqueId,
                Remark: remark
            });
...
function processCreditPayment(amount) {
    ...
    const params = {
        ...
        PaymentType: "aio",
        TotalAmount: amount,
        TradeDesc: "BP Payment Service",
        ItemName: "BP Payment Service",
...
// 生成唯一ID (限制總長度 18 字元，配合 BP 前綴共 20 字元)
function generateUniqueId() {
    const now = new Date();
    // 格式: MMDDHHMMSS (10字元) + 隨機8位
